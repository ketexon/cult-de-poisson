...
class ToonShaderGUI : BaseShaderGUI
{
    // Properties
    private SimpleLitGUI.SimpleLitProperties shadingModelProperties;
    MaterialProperty nCelsProperty;
    ...
    public override void FindProperties(MaterialProperty[] properties)
    {
        ...
        nCelsProperty = FindProperty("_NSteps", properties);
    }
    ...
    public override void DrawSurfaceOptions(Material material)
    {
        ...
        materialEditor.IntegerProperty(nCelsProperty, "Number of Toon Steps");
    }
