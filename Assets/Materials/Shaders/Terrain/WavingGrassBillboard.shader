...
Shader "Hidden/TerrainEngine/Details/UniversalPipeline/BillboardWavingDoublePass"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Materials/Shaders/Terrain/WavingGrassInput.hlsl"
            #include "Assets/Materials/Shaders/Terrain/WavingGrassPasses.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/Materials/Shaders/Terrain/WavingGrassInput.hlsl"
            #include "Assets/Materials/Shaders/Terrain/WavingGrassDepthNormalsPass.hlsl"
            ENDHLSL
        }
    }
}
