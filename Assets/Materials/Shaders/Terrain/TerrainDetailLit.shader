Shader "Hidden/TerrainEngine/Details/UniversalPipeline/Vertexlit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Materials/Shaders/Terrain/TerrainDetailLitInput.hlsl"
            #include "Assets/Materials/Shaders/Terrain/TerrainDetailLitPasses.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/Materials/Shaders/Terrain/TerrainToonInput.hlsl"
